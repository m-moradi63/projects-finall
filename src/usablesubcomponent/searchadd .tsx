export const Searchesadd = () => {
  return (
    <div className="flex items-center rounded-lg  border-2 solid w-[11rem] h-[2rem] border-slate-400">
      <svg
      ...
      <input type="text" className="w-[9rem] mr-[0rem]  accent-white rounded-lg" placeholder="Add a File" />
    </div>
  );
};
