    ...
    return (
        <div className="flex justify-between ml-4 mt-4  ">
                ...
                <div className="flex justify-between w-[32rem] mr-6 ">
                    ...
                    <button className="rounded-full border-solid border-2 border-slate-300 border-indigo-600... rounded-xl">
                        <img src="https://avatars.githubusercontent.com/u/138288308?v=4" alt="" size="32" height="32" width="32" data-view-component="true" className="avatar circle" />
                    </button>
                </div>
            </div>
