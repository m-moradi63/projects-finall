    ...
    <div className="w-[750px]   text-xs  ">
      <div className="flex justify-between w-[45rem] border-b mb-[1rem] h-[3rem]">
        ...
        <select onChange={(e) => {
          ...
          className="border-2 border-solid  rounded-lg h-[2rem] bg-[#fff]" id="type">
          <option className="border-b" hidden>Type</option>
          <option className="" disabled value="">Select Type</option>
          <option className="border-2 border-solid" value="All" selected={filter == "All" ? true : false}>All</option>
          ...
          <option className="border-b" value="Can be sponsored"  selected={filter == "Can be sponsored" ? true : false}>Can be sponsored</option>
          <option className="border-b" value="Mirrors" selected={filter == "Mirrors" ? true : false} >Mirrors</option>
          <option className="border-b" value="Templates" selected={filter == "Templates" ? true : false}>Templates</option>
