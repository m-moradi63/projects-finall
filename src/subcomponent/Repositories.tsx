...
import { apiRepos ,User } from '../compunents/getUser';

export function Reposit(props:string) {
  const [repositState, setrepositState] = useState<User | {}>([]);
  useEffect(() => {
  ...
  return (
    ...
    <div className="w-[750px]   text-xs  ">
      ...
      <div className="flex flex-wrap  ">{repositState.map((item) => {
        return (

          <div className="border-b-[1px] border-neutral-300 mb-[1rem]  w-[45rem] ">
